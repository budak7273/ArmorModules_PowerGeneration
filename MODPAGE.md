...
This is an **addon mod** for [**PowerSuit Modules**](https://ficsit.app/mod/ArmorModules/) that offers numerous modules focused on granting the player additional Suit Power generation options. This includes:

- Passive power production options
- Suit Fuel-consuming generators
- Zipline and Hypertube usage-based generators
- Generate power from ambient radiation
- ... and more!
